...
enum class LlmPromptCode(val code: String, val title: String) {
    ...
    CONSULTING_SYSTEM_INVESTMENT_ALL("consulting.system.investment-all", "종합 상담 시스템 프롬프트 - 사주+타로"),
    ...
    CONSULTING_QUESTION_INVESTMENT_ALL("consulting.question.investment-all", "종합 상담 기본 질문 - 사주+타로");
}
